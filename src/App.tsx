...
function App() {
  ...
  const buttonPress = (symbol: string) => {
    if(symbol === "clear"){
      ...
      //split by operators & get the last number
      const lastNumber = expression.split(/[-+/*]/g).pop();
      //if last number already have a decimal, return. don't add another
    ...
    <div className="container">
      ...
      <div id="calculator">
        <div id="display" style={{textAlign: "right"}}>
         ...
         <button id="negative" onClick={() => buttonPress("negative")}className="light-blue">+/-</button>
         <button id="percentage" onClick={() => buttonPress("percentage")}className="light-blue">%</button>
         <button id="divide" onClick={() => buttonPress("/")}className="silver">/</button>
         ...
         <button id="multiply" onClick={() => buttonPress("*")}className="silver">*</button>
         ...
         <button id="subtract" onClick={() => buttonPress("-")}className="silver">-</button>
         ...
         <button id="add" onClick={() => buttonPress("+")}className="silver">+</button>
         <button id="zero" onClick={() => buttonPress("0")}className="light-grey">0</button>
         <button id="decimal" onClick={() => buttonPress(".")}className="silver">.</button>
         <button id="equals" onClick={() => buttonPress("=")}className="light-blue">=</button>
      </div>
    </div>
    </>
  );
